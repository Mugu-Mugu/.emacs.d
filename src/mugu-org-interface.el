...
(defmenu mugu-orgi-menu-org-major-mode
  ...
  ("cj" (mugu-orgw-checkout-headline-to-dailies #'org-roam-dailies-capture-today) "checkout headline to today" :column "Dailies")
  ("ct" (mugu-orgw-checkout-headline-to-dailies #'org-roam-dailies-capture-tomorrow) "checkout headline to tomorrow" )
  ("cy" (mugu-orgw-checkout-headline-to-dailies #'org-roam-dailies-capture-yesterday) "checkout headline to yesterday" )
  ("cd" (mugu-orgw-checkout-headline-to-dailies #'org-roam-dailies-capture-date) "checkout headline to a date")
