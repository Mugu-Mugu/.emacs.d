(custom-set-variables
 ...
 '(beacon-color "darkorange" nil nil "Customized with use-package beacon")
 ...
 '(company-auto-commit-chars '(95 40 41 46 34 36 39 60 62 47))
 ...
 '(company-prescient-sort-length-enable nil nil nil "Customized with use-package company-prescient")
 ...
 '(dumb-jump-confirm-jump-to-modified-file nil nil nil "Customized with use-package dumb-jump")
 ...
 '(enh-ruby-deep-indent-paren nil nil nil "Customized with use-package enh-ruby-mode")
 '(enh-ruby-hanging-paren-deep-indent-level 2 nil nil "Customized with use-package enh-ruby-mode")
 '(epg-pinentry-mode 'loopback)
 '(ess-swv-pdflatex-commands '("texi2pdf" "pdflatex" "make" "xelatex"))
 '(evil-ex-search-vim-style-regexp t)
 '(evil-insert-state-modes
   '(comint-mode erc-mode eshell-mode geiser-repl-mode gud-mode inferior-apl-mode inferior-caml-mode inferior-emacs-lisp-mode inferior-j-mode inferior-python-mode inferior-scheme-mode inferior-sml-mode internal-ange-ftp-mode prolog-inferior-mode reb-mode shell-mode slime-repl-mode))
 '(evil-jumps-cross-buffers nil nil nil "Customized with use-package evil")
 '(evil-motion-state-modes
   '(apropos-mode color-theme-mode command-history-mode dictionary-mode undo-tree-visualizer-mode))
 '(evil-overriding-maps nil nil nil "Customized with use-package evil")
 '(evil-owl-idle-delay 0.0 nil nil "Customized with use-package evil-owl")
 ...
 '(evil-surround-pairs-alist
   '((40 "(" . ")")
     ...
     (102 . evil-surround-function)) nil nil "Customized with use-package evil-surround")
 '(evil-symbol-word-search t nil nil "Customized with use-package evil")
 '(evil-toggle-key "C-z" nil nil "maybe to do")
 '(evil-undo-system 'undo-tree)
 '(evil-vsplit-window-right t)
 '(evil-want-C-i-jump t nil nil "Customized with use-package evil")
 '(evil-want-keybinding nil)
 '(evilmi-shortcut "%" t nil "Customized with use-package evil-matchit")
 '(expand-region-contract-fast-key "<backspace>" nil nil "Customized with use-package expand-region")
 ...
 '(ivy-posframe-display-functions-alist
   '((swiper . ivy-posframe-display-at-frame-bottom-window-center)
     (t . ivy-posframe-display-at-frame-center)) nil nil "Customized with use-package ivy-posframe")
 '(ivy-posframe-height-alist '((swiper . 20) (t . 20)) nil nil "Customized with use-package ivy-posframe")
 '(ivy-prescient-sort-commands
   '(:not swiper ivy-switch-buffer mugu-counsel-fzf-file mugu-project-find-file counsel-fzf counsel-yank-pop mugu-orgi-headlines) nil nil "Customized with use-package ivy-prescient")
 ...
 '(org-agenda-files '("/home/david/org/" "/home/david/.emacs.d/emacs.org"))
 ...
 '(org-clock-frame-title-format '(:eval (format "emacs %s" org-mode-line-string)))
 ...
 '(org-export-backends '(ascii beamer html icalendar latex md odt deck))
 ...
 '(org-roam-dailies-capture-templates
   '(("d" "default" entry #'org-roam-capture--get-point "* TODO %? %(format \"\\n%i\")" :file-name "daily/%<%Y-%m-%d>" :head "#+title: %<%Y-%m-%d>
" :olp
("Inbox")
:unnarrowed t)))
 ...
 '(org-todo-keywords
   '((sequence "TODO(t)" "WAIT(w)" "NEXT(n)" "ACTIVE(a)" "|" "DONE(d)" "CANCELLED(c)")))
 '(org-use-sub-superscripts '{})
 '(persp-sort-chronologically t)
 '(posframe-inhibit-double-buffering nil nil nil "Customized with use-package ivy-posframe")
 ...
 '(safe-local-variable-values
   '((mugu-ruby-prettify-cmd . "docker exec wakeo_platform_api_1 npm run prettify")
     (mugu-ruby-prettify-cmd . "/home/david/work/wakeo_platform/dcli npm run prettify")
     (rspec-use-docker-when-possible . t)
     (mugu-ruby-prettify-cmd . "dcli npm run prettify")
     (mugu-ruby-prettify-cmd . "npm run prettify")
     ...
     (rspec-docker-container . "sls")
     (rspec-use-bundler-when-possible)
     (mugu-ruby-prettify-cmd . "docker-compose exec sls bundle exec rbprettier ")
     (mugu-ruby-prettify-cmd . "docker-compose exec sls bundle exec rbprettier --write ")
     (mugu-ruby-prettify-cmd . "bundle exec rbprettier --write ")
     (rspec-docker-cwd . "/sls_dev/")
     (flycheck-ruby-rubocop-executable . "docker-compose exec sls rubocop ")
     (flycheck-ruby-rubocop-executable . "spring rubocop ")
     (flycheck-ruby-rubocop-executable . "docker-compose exec -T wt bundle exec rubocop")
     (flycheck-ruby-rubocop-executable . "/home/david/work/wakeo_platform/tmp/rubocop")
     (rspec-docker-command . "docker-compose -f compose.yaml -f compose.linux.yaml exec")))
 '(savehist-additional-variables '(search ring regexp-search-ring) nil nil "Customized with use-package savehist")
 '(savehist-autosave-interval 60 nil nil "Customized with use-package savehist")
 '(semantic-mode nil)
 '(show-paren-mode t)
 ...
 '(swiper-action-recenter t nil nil "Customized with use-package swiper")
 '(swiper-stay-on-quit t nil nil "Customized with use-package swiper")
 '(switch-to-buffer-obey-display-actions t)
 '(sx-default-site "stackoverflow")
 '(tab-always-indent 'complete)
 '(tab-width 4)
 '(tool-bar-mode nil)
 '(undo-tree-mode-lighter "" nil nil "Customized with use-package undo-tree")
 '(use-file-dialog nil)
 ...
 '(vc-handled-backends nil nil nil "Customized with use-package magit")
