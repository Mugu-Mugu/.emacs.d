(custom-set-variables
 ...
 '(org-super-agenda-header-prefix " " nil nil "Customized with use-package org-ql")
 ...
 '(safe-local-variable-values
   '((test-case-name . twisted\.test\.test_reflect)
     ...
     (mugu-ruby-prettify-cmd . "bundle exec rbprettier --print-width 110 --write")
     ...
     (rspec-spec-command . "export ENV=test RAILS_ENV=test && bundle exec rspec ")
     (rspec-docker-command . "docker-compose -f compose.yaml -f compose.linux.yaml exec")
